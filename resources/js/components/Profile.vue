    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-3">
              ...
              <div class="widget-user-header text-white" style="background-image:url('./img/usercover.png')">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                         <div class="widget-user-image">
                            <label for="imagepreview" class="col-sm-2 control-label">Image Preview:</label>
                            <img class="img-squre" :src="getProfilePhoto()" alt="User Avatar" height="50px" weight="30px">
                        </div>
                        </div>
                        <div class="form-group">
            ...
            if(file['size'] < 2111775){
             ...
             reader.readAsDataURL(file);
                ...
                swal.fire({
                  icon:'error',
                  title:'Oops...',
                  text:'Please upload less then 2MB file',
                })
            }
          }
        },
